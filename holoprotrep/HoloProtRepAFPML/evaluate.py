...
def evaluate(
    ...
    for fold_index in range(len(model_label_pred_lst)):
        ...
        for result_element in range(len(mcm)):
            acc.append(
                (mcm[result_element][0][0] + mcm[result_element][1][1])
                / (
                    mcm[result_element][0][0]
                    + mcm[result_element][0][1]
                    + mcm[result_element][1][0]
    ...
    mean_result_list.append(
        [representation_name, classifier_name_concated]
        + [
            np.mean(acc_cv),
            np.mean(std_acc_cv),
            np.mean(f_max_cv),
