...
def select_best_model_with_hyperparameter_tuning(
    ...
    for classifier in models:
        ...
        if classifier == "RandomForestClassifier":
            ...
            kf = KFold(n_splits=5, shuffle=True, random_state=random_state)
            parameters = {
                "model_classifier__n_estimators": [10, 50, 100, 150, 200],
                "model_classifier__max_depth": [3, 4, 5, 6, 7, 8, 9, 10, 11],
                "model_classifier__min_samples_leaf": [1, 5, 10, 20, 100],
            }
            ...
            parameters = {
                ...
                "model_classifier__kernel": ["linear", "poly", "rbf"],
            ...
            parameters = {
                ...
                "model_classifier__leaf_size": list(
                    range(1, int(len(model_label_array) / 5))
                ),
